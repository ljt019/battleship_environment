...
class MoveInput(Input):
    def __init__(self, **kwargs):
        super().__init__(placeholder="Enter move (e.g., b6)", **kwargs)
...
class BattleshipApp(App):
    ...
    def __init__(self, board_size: int = 10, seed: int | None = None, **kwargs):
    ...
    def handle_move(self, move: str) -> None:
        ...
        self.last_result = {"move": move, "hit": hit, "sunk": sunk, "invalid": invalid}
        self.refresh_ui()
    ...
    def action_reset(self) -> None:
        ...
        self.last_result = None
        self.refresh_ui()
        self.query_one("#move-input").value = ""
    ...
    def on_input_submitted(self, event: Input.Submitted) -> None:
        self.handle_move(event.value)
        event.input.value = ""


def main():
    parser = argparse.ArgumentParser(description="Interactive Battleship Emulator TUI")
    ...
    app = BattleshipApp(board_size=args.size, seed=args.seed)
    app.run()
